...
---@overload fun(imagePath: string, spriteData: {x: integer, y: integer, width: integer, height:integer}, names: string[])
---@type SpriteAtlas
...
--- @return any quad The love quad associated with the sprite name
...
--- @return any quad The love quad associated with the sprite index
...
--- @param names table? The names of the sprites, mapping left to right, top to bottom. If not supplied the quads will be sorted by index not name.
--- @return SpriteAtlas The created SpriteAtlas instance
