return spectrum.Keybinding {
   { key = "z", action = "undo", description = "Undo the most recent change." },
   { key = "y", action = "redo", description = "Undo the most recent change." },
   ...
   { key = "o", action = "oval", description = "Swap to the oval tool." },
