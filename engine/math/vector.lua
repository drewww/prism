...
---@class prism.Vector2 : prism.Object
--- A Vector2 represents a 2D vector with x and y components.
---@overload fun(x: number?, y: number?): prism.Vector2
---@operator add(prism.Vector2): prism.Vector2
---@operator sub(prism.Vector2): prism.Vector2
---@operator mul(prism.Vector2): prism.Vector2
---@operator unm(): prism.Vector2
...
---@return prism.Vector2 # A copy of the vector.
...
---@return prism.Vector2 The rotated vector.
function Vector2:rotateClockwise()
   return Vector2(self.y, -self.x)
end

--- Adds two vectors together.
---@param a prism.Vector2 The first vector.
---@param b prism.Vector2 The second vector.
---@return prism.Vector2 # The sum of the two vectors.
...
---@param a prism.Vector2 The first vector.
---@param b prism.Vector2 The second vector.
---@return prism.Vector2 # The difference of the two vectors.
...
---@param a prism.Vector2 The vector.
---@param b number The scalar.
---@return prism.Vector2 # The product of the vector and the scalar.
function Vector2.__mul(a, b)
   return Vector2(a.x * b, a.y * b)
end

--- Negates the vector.
---@param a prism.Vector2 The vector to negate.
---@return prism.Vector2 # The negated vector.
...
--- @param self prism.Vector2 The starting vector (A).
--- @param vec prism.Vector2 The ending vector (B).
--- @param t number The interpolation factor (0 <= t <= 1).
--- @return prism.Vector2 # The interpolated vector.
...
--- @alias Neighborhood prism.Vector2[]
