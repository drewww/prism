...
--- @field requirements table<string> A table of requirements that must be met for the System to be attached to a Level.
--- @field softRequirements table<string> A table of optional requirements that ensure proper order if both Systems are attached.
