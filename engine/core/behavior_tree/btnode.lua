...
--- @class BTNode : Object
--- @overload fun(run: fun(self: BTNode, level: Level, actor: Actor, controller: BTControllerComponent): boolean|Action): BTNode
--- @type BTNode
...
--- @param run fun(self: BTNode, level: Level, actor: Actor, controller: BTControllerComponent): boolean|Action
